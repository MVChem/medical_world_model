...
Build with `make` (requires LaTeX, BibTeX, latexmk, LibreOffice, Inkscape, and Python with Matplotlib, NumPy, Pillow, and Arial).
PDFs stay local. Missing figure PDFs are rebuilt from the tracked PowerPoint/SVG files and appendix script.
