...
set of 138 Montgomery images supplies human lung masks for the main-table
Lung Dice metric. Dice against CXAS pseudo-labels on 447 test images is
reserved for supplementary analysis. Padding is excluded from spatial losses
and metrics. Both evaluations remain pending because the
