...
DEFAULT_OUTPUT = SCRIPT_DIR.parents[1] / "ppt" / "appendix_fig1_v1.pdf"
...
def build(output: Path):
    ...
    top_cases = [
        {
            ...
            "images": (
                ASSETS / "case_a_current_cxr.jpg",
                ASSETS / "case_a_observed_followup_cxr.jpg",
            ),
        ...
        },
        {
            ...
            "images": (
                ASSETS / "case_b_current_cxr.jpg",
                ASSETS / "case_b_observed_followup_cxr.jpg",
            ),
            "times": ("Current  ·  t0", "Observed follow-up  ·  t1"),
            "reports": (
    ...
    serial_images = (
        ASSETS / "case_c_t0.jpg",
        ASSETS / "case_c_t1.jpg",
        ASSETS / "case_c_t2.jpg",
        ASSETS / "case_c_t3_observed_followup.jpg",
    )
...
def main():
    parser = argparse.ArgumentParser(description="Build appendix Figure 1 v1 as a conference-ready PDF.")
