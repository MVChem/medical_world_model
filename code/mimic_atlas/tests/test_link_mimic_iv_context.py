...
from mimic_atlas.link_mimic_iv_context import build_outputs
...
class LinkedContextSmokeTest(unittest.TestCase):
    def test_links_transition_to_admission_stay_and_interval_events(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertEqual(csv_row["cxr_source_database"], "MIMIC-CXR-JPG-2.0.0")
            self.assertEqual(csv_row["linkage_context_source_database"], "MIMIC-IV-3.1")
