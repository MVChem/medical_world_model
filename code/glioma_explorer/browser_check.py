...
async def main():
    ...
    async with async_playwright() as pw:
        ...
        assert 'T5' in await page.locator('#mu-timeline').inner_text()
        ...
        result['checks'].append('MU real MRI, original T1/T2/T5 selection, NETC labels and single-visit patient')
