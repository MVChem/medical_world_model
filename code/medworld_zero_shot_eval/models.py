...
PROJECT = Path(os.environ.get('MEDWORLD_PROJECT_ROOT', os.environ.get('MEDWORLD_PROJECT', Path(__file__).resolve().parents[2])))
...
def models():
    ...
    return [
        ...
        dict(id='qwen9b', label='Qwen3.5-9B', family='qwen', path=p('Qwen/Qwen3.5-9B','c202236235762e1c871ad0ccb60c8ee5ba337b9a'), tp=1),
