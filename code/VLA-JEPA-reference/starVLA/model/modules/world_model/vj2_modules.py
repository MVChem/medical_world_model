...
def rotate_queries_or_keys(x, pos):
    ...
    y = y.flatten(-2)
    # PyTorch 2.11 promotes this expression when float32 position tensors are
    # combined with bf16 activations. SDPA requires q, k, and v to share a
    # dtype, so preserve the incoming activation dtype explicitly.
