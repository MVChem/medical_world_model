...
[实验索引](../experiments/README.md) · [当前事项](../docs/TODO.md)
...
归档前核验：本页最终匹配比较、六模型三组结果表及 Bicubic 数值逐项与原始 JSON 对齐；六模型完成状态和请求数已检查。原始模型协议 6 项测试、密集任务协议 7 项测试全部通过（包含本地患者划分和 LR 缓存核验）；命令见[开发说明](../docs/DEVELOPMENT.md)。
