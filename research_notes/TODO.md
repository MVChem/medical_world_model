...
- [x] 核对两组 24,000 步 final checkpoint 的四任务测试结果、样本及训练预算匹配，见 [09-12 小结](0912_recent_experiments_summary.md)。
- [ ] 复盘疾病列表、分割和报告读出的失败样例；解释 slots 未在所有任务取得改善的原因。
- [x] 完成六个原始 Qwen／MedGemma 的零样本评测并归档聚合结果。
- [x] 完成 09-12 冻结 VLM 的 55 项队列，核对 epoch 20 分割／×4 SR／解剖定位结果及独立 82 对方向评测；于 09-12 12:14 完成，见 [结果来源与实验时间](0913_table1_table2_results_provenance.md)。
